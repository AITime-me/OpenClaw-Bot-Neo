...
7 MEDIUM); first security corrective re-review **BLOCKED**; second corrective package pending
independent re-review; no Build 3.6B closeout; no real Timeweb/SSH/VPS; no production connector
wiring. See [infrastructure platform](infrastructure-platform.md).
