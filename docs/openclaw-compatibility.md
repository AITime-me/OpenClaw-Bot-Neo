...
| OAuth | Subscription OAuth without API-key billing; ChatGPT auth mode exists | official OpenAI / openai/codex research (Build 3.7E0) | 2026 | proposed `2026.7.1` | PARTIAL | Future owner-approved capability probe | technical PASS; live UNRESOLVED | API-key mode forbidden |
...
| Telegram channel | Temporary transport adapter only; core stays channel-independent; equal future mobile adapter | official documentation reference to be pinned | TBD | proposed `2026.7.1` | UNVERIFIED | Contract/auth/replay/redaction tests | TBD | Build 3.7F blocked pending E1/encryption/ops approval |
| Subscription completion route | Headless ChatGPT Plus/Codex subscription without API-key billing | official OpenAI / openai/codex research (Build 3.7E0) | 2026 | proposed `2026.7.1` | PARTIAL | Account prerequisites + capability probe before E1 | technical PASS; live UNRESOLVED | Absolute zero-credit-spend unmet; retain ChatGPT/Codex |
